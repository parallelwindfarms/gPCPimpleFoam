...
Foam::uqeddyViscosity<BasicTurbulenceModel>::uqeddyViscosity
(
    const word& type,
...
:
    uqlinearViscousStress<BasicTurbulenceModel>
    (
        type,
        alpha,
        rho,
    ...
    (
        IOobject
        (
            IOobject::groupName("nut"+std::to_string(uqNode), alphaRhoPhi.group()),
            this->runTime_.timeName(),
            this->mesh_,
            IOobject::MUST_READ,
            IOobject::AUTO_WRITE
...
template<class BasicTurbulenceModel>
bool Foam::uqeddyViscosity<BasicTurbulenceModel>::read()
{
...
Foam::uqeddyViscosity<BasicTurbulenceModel>::R() const
{
...
template<class BasicTurbulenceModel>
void Foam::uqeddyViscosity<BasicTurbulenceModel>::validate()
{
    correctNut();
}
...
template<class BasicTurbulenceModel>
void Foam::uqeddyViscosity<BasicTurbulenceModel>::correct()
{
